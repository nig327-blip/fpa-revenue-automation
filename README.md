...
* **Architecture Portability:** Configured purely with standalone relative pathing, ensuring the pipeline executes natively out of  thebox in any production deployment.
